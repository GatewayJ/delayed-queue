...
func (q *Queue) Push(data interface{}, f func()) {
	if q.timeSpy {
		data = TimeWrapper{
			Data:      data,
...
func (q *Queue) TPush(data interface{}, f func()) {
	q.Push(data, f)
}
...
func (q *Queue) SafePush(data interface{}, f func()) {
	q.Mutex.Lock()
	defer q.Mutex.Unlock()
	q.Push(data, f)
}
...
func (q *Queue) SafeTPush(data interface{}, f func()) {
	q.Mutex.Lock()
	defer q.Mutex.Unlock()
	q.TPush(data, f)
}
